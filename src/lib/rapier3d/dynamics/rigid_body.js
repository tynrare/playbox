...
export class RigidBody {
     ...
     * the function returns this object instead of creating a new one.
     */
    principalInertiaLocalFrame(target) {
     ...
     * the function returns this object instead of creating a new one.
     */
    effectiveWorldInvInertia(target) {
     ...
     * the function returns this object instead of creating a new one.
     */
    effectiveAngularInertia(target) {
