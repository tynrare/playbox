...
import { scratchBuffer, VectorOps } from "../math";
/**
...
export class DynamicRayCastVehicleController {
     ...
     */
    wheelChassisConnectionPointCs(i, target) {
