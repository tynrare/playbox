...
export class VectorOps {
    ...
    static fromBuffer(buffer, target) {
        if (!buffer)
            return null;
        target !== null && target !== void 0 ? target : (target = VectorOps.zeros());
        target.x = buffer[0];
        target.y = buffer[1];
        target.z = buffer[2];
        return target;
...
export class RotationOps {
    ...
    static fromBuffer(buffer, target) {
        if (!buffer)
            return null;
        target !== null && target !== void 0 ? target : (target = RotationOps.identity());
        target.x = buffer[0];
        target.y = buffer[1];
        target.z = buffer[2];
        target.w = buffer[3];
...
export class SdpMatrix3Ops {
    static fromBuffer(buffer, target) {
        if (!buffer)
            return null;
        target !== null && target !== void 0 ? target : (target = new SdpMatrix3(buffer));
